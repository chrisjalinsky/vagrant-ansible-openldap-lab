...
{% if phpldapadmin_debug_level is defined and phpldapadmin_debug_level != "" %}
$config->custom->debug['level'] = {{ phpldapadmin_debug_level }};
{% endif %}
...
{% if phpldapadmin_hide_template_warning is defined and phpldapadmin_hide_template_warning != "" %}
$config->custom->appearance['hide_template_warning'] = {{ phpldapadmin_hide_template_warning }};
{% endif %}
...
$servers->setValue('server','base',array('{{ phpldapadmin_server_base }}'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','{{ phpldapadmin_login_bind_id }}');
...
//{% if phpldapadmin_server_tls is defined and phpldapadmin_server_tls != "" %}
//$servers->setValue('server','tls',{{ phpldapadmin_server_tls }});
//{% endif %}
